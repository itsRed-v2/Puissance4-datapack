scoreboard players reset waitbuild puissance4
scoreboard players set timer puissance4 0
scoreboard players operation direction puissance4 = direction1 puissance4

execute if entity @e[name="Puissance 4",limit=1,type=armor_stand,tag=done,tag=!notbuild] run function puissance4:delete

tag @e[name="Puissance 4",limit=1,type=armor_stand,tag=done,tag=notbuild] remove notbuild
...
execute at @e[name="Puissance 4",limit=1,type=armor_stand,tag=done] run setblock ^ ^-2 ^4 minecraft:sticky_piston[facing=up]
execute at @e[name="Puissance 4",limit=1,type=armor_stand,tag=done] run setblock ^ ^-2 ^-4 minecraft:sticky_piston[facing=up]
execute at @e[name="Puissance 4",limit=1,type=armor_stand,tag=done] run setblock ^ ^-1 ^4 minecraft:blue_concrete
execute at @e[name="Puissance 4",limit=1,type=armor_stand,tag=done] run setblock ^ ^-1 ^-4 minecraft:orange_concrete
...
tellraw @a ["",{"text":"[","color":"gray"},{"text":"Puissance 4","color":"gold"},{"text":"]","color":"gray"},{"text":" Le puissance 4 a été construit.","color":"yellow"}]