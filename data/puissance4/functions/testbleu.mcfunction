...
execute as @e[name="test",tag=puissance4] at @s if block ^-1 ^ ^ minecraft:blue_concrete_powder run tp @s ^-1 ^ ^
execute as @e[name="test",tag=puissance4] at @s if block ^-1 ^ ^ minecraft:blue_concrete_powder run tp @s ^-1 ^ ^
execute as @e[name="test",tag=puissance4] at @s if block ^-1 ^ ^ minecraft:blue_concrete_powder run tp @s ^-1 ^ ^
execute as @e[name="test",tag=puissance4] at @s if block ^-1 ^ ^ minecraft:blue_concrete_powder run tp @s ^-1 ^ ^
...
execute unless score score puissance4 matches 4 run function puissance4:testbleu2
